    ...
    <div className="w-full max-w-7xl mx-auto space-y-6 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        <StatCard
          ...
          subtitle={`Goal: ${stats.step_goal.toLocaleString()}`}
          icon={Footprints}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-[2.5rem] p-8 shadow-sm border border-gray-100 dark:border-gray-700 text-center relative overflow-hidden flex-1 flex flex-col justify-between">
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">
                Goal: {stats.step_goal.toLocaleString()}
              </span>
            </div>
            ...
            <div className="relative w-48 h-48 mx-auto mb-8">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <div className="text-xs font-bold tracking-widest text-gray-400 uppercase mt-1">Steps</div>
              </div>
            </div>
            ...
            {exercises.map((e, i) => (
              <div key={i} className="bg-white dark:bg-gray-800 rounded-[2rem] p-6 shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-between hover:shadow-md transition-shadow">
                <div>
                  ...
                  <h4 className="font-bold text-gray-900 dark:text-white mb-1">{e.name}</h4>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-[2.5rem] p-6 lg:p-8 shadow-sm border border-gray-100 dark:border-gray-700 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {weeklyPlan.map((d, i) => (
            ...
            >
              ...
              <div>
                <h4 className="font-bold text-gray-900 dark:text-white text-lg mb-1">{d.day}</h4>
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">{d.workout}</p>
              </div>
            </div>
          ))}
        </div>
          ...
          <div className="relative w-full max-w-lg bg-white dark:bg-gray-800 rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col transform transition-all">
            ...
            <div className={`p-6 lg:p-8 flex items-center justify-between border-b ${selectedDayPlan.rest
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{selectedDayPlan.day}</h3>
                  <p className="text-sm font-semibold text-gray-500 dark:text-gray-400 mt-1">{selectedDayPlan.workout} • {selectedDayPlan.duration}</p>
                </div>
              </div>
              <button
                onClick={() => setSelectedDayPlan(null)}
            ...
            <div className="p-6 lg:p-8 overflow-y-auto max-h-[60vh]">
              <div className="flex items-center gap-2 mb-6 text-indigo-600 dark:text-indigo-400">
                ...
                <h4 className="font-bold text-lg">AI Generated Plan</h4>
              </div>

              <div className="space-y-4">
                {getMockGymSets(selectedDayPlan.workout).map((set, idx) => (
                  <div key={idx} className="flex items-center justify-between p-4 rounded-2xl bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800">
                    <div>
                      <h5 className="font-bold text-gray-900 dark:text-white mb-1">{set.name}</h5>
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs font-bold text-gray-400 uppercase tracking-wider mt-1">
                        {selectedDayPlan.rest || set.reps.includes('min') ? 'Duration' : 'Reps'}
                      </div>
                    </div>
                  </div>
                ))}
