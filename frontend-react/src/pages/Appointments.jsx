    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-[2rem] p-6 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1.5 relative overflow-hidden group cursor-pointer">
          ...
          <div className="flex items-start justify-between relative z-10">
            <div>
              <p className="text-sm font-bold text-gray-500 dark:text-gray-400 mb-1 tracking-wide uppercase">Upcoming</p>
          ...
          <div className="mt-5 flex items-center text-sm">
            <span className="font-semibold text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-700/50 px-3 py-1 rounded-full">Scheduled</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-[2rem] p-6 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1.5 relative overflow-hidden group cursor-pointer">
          ...
          <div className="flex items-start justify-between relative z-10">
            <div>
              <p className="text-sm font-bold text-gray-500 dark:text-gray-400 mb-1 tracking-wide uppercase">Completed</p>
          ...
          <div className="mt-5 flex items-center text-sm">
            <span className="font-semibold text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-700/50 px-3 py-1 rounded-full">Past visits</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-[2rem] p-6 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1.5 relative overflow-hidden group cursor-pointer">
          ...
          <div className="flex items-start justify-between relative z-10">
            <div>
              <p className="text-sm font-bold text-gray-500 dark:text-gray-400 mb-1 tracking-wide uppercase">Hospitals</p>
          ...
          <div className="mt-5 flex items-center text-sm">
            <span className="font-semibold text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-700/50 px-3 py-1 rounded-full">Locations</span>
          </div>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div>
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
              <CalendarIcon className="w-6 h-6 text-blue-500" /> Upcoming
            </h3>
            ...
            <div className="space-y-4">
              {upcoming.length > 0 ? upcoming.map(a => {
                  ...
                  <div key={a.id} className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-gray-700 flex flex-row items-center justify-between gap-5 hover:shadow-md hover:-translate-y-0.5 transition-all w-full">
                    ...
                    <div className="flex flex-row items-center gap-5 flex-1 min-w-0">
                      ...
                      <div className="flex flex-col items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-blue-50 dark:bg-blue-900/30 rounded-xl shrink-0">
                        ...
                        <span className="text-[10px] font-bold text-blue-500 uppercase tracking-wider mt-1">{d.toLocaleDateString('en', { month: 'short', year: 'numeric' })}</span>
                      </div>
                      
                      {/* Details */}
                      <div className="flex-1 text-left min-w-0">
                        <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-1 truncate">Dr. {a.doctor}</h4>
                        <p className="text-sm font-semibold text-blue-600 dark:text-blue-400 mb-2 truncate">{a.specialty}</p>
                    ...
                    <div className="flex flex-col items-center justify-center gap-3 shrink-0 w-48 border-gray-100 dark:border-gray-700">
                      ...
                      <div className="flex flex-col gap-2 w-full">
                        {a.ai_prep_notes ? (
                          ...
                          >
                            <Bot className="w-4 h-4" /> View AI Prep
                          </button>
                        ) : (
                          <button 
                          ...
                          >
                            <Sparkles className="w-4 h-4" /> AI Prep
                          </button>
                        )}
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-10 shadow-sm border border-gray-100 dark:border-gray-700 text-center flex flex-col items-center justify-center">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 font-medium">No upcoming appointments. Schedule one now!</p>
                </div>
              )}
            </div>
          </div>
          ...
          {past.length > 0 && (
            <div>
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2 opacity-70">
                <CheckCircle2 className="w-6 h-6 text-emerald-500" /> Past
              </h3>
                    ...
                    <div key={a.id} className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-gray-700 flex flex-row items-center justify-between gap-5 grayscale-[30%] text-left w-full">
                      <div className="flex flex-row items-center gap-5 flex-1 min-w-0">
                        <div className="flex flex-col items-center justify-center w-16 h-16 bg-gray-50 dark:bg-gray-900/50 rounded-xl shrink-0">
                          ...
                          <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mt-1">{d.toLocaleDateString('en', { month: 'short' })}</span>
                        </div>
                        
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-wrap items-center gap-3 mb-1">
                            <h4 className="text-lg font-bold text-gray-900 dark:text-white truncate max-w-[200px]">Dr. {a.doctor}</h4>
                            <span className="bg-emerald-50 text-emerald-600 dark:bg-emerald-900/20 dark:text-emerald-400 px-2 py-0.5 rounded text-[10px] font-bold shrink-0">Completed</span>
                          </div>
                          <p className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-2 truncate">{a.specialty}</p>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-900/10 dark:to-blue-900/10 border border-cyan-100 dark:border-cyan-900/30 rounded-[2rem] p-6 lg:p-8 shadow-sm">
            <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
              <Bot className="w-6 h-6 text-cyan-500" /> AI Suggestions
            </h4>
            ...
            <div className="space-y-4">
              {suggestions.map((s, i) => (
                <div key={i} className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-md rounded-2xl p-4 border border-white/40 dark:border-gray-700/50 shadow-sm">
                  <div className="flex justify-between items-start mb-2">
                    <span className="font-bold text-sm text-gray-900 dark:text-white">{s.specialist}</span>
              ...
              {suggestions.length === 0 && (
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400 text-center py-4">No suggestions right now. You're up to date!</p>
              )}
            </div>
          </div>
        </div>
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white dark:bg-gray-800 w-full max-w-xl rounded-3xl shadow-2xl overflow-hidden border border-gray-100 dark:border-gray-700 animate-in zoom-in-95 duration-200">
            <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-800/50">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2">
                <CalendarIcon className="w-5 h-5 text-blue-500" /> New Appointment
              </h3>
            ...
            <div className="p-6 space-y-5">
              <div>
                <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1.5">Doctor Name</label>
                <input 
                  type="text" 
                  value={newApt.doctor} 
                  onChange={(e) => setNewApt({...newApt, doctor: e.target.value})} 
                  placeholder="e.g. Smith" 
                  className="w-full bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2.5 text-sm font-medium focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all dark:text-white"
                />
              </div>
              
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1.5">Specialty</label>
                  <select 
                    value={newApt.specialty} 
                    onChange={(e) => setNewApt({...newApt, specialty: e.target.value})}
                    className="w-full bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2.5 text-sm font-medium focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all dark:text-white appearance-none"
                  >
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1.5">Hospital / Clinic</label>
                  <input 
                    type="text" 
              ...
              <div>
                ...
                <textarea 
                  ...
                  placeholder="Reason for visit, symptoms to mention..."
                  rows="3"
                  className="w-full bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 text-sm font-medium focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all resize-none dark:text-white"
                ></textarea>
              </div>
            </div>
            ...
            <div className="px-6 py-4 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-100 dark:border-gray-700 flex justify-end gap-3">
              <button onClick={() => setShowForm(false)} className="px-5 py-2.5 rounded-xl font-bold text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">Cancel</button>
              <button onClick={handleAdd} className="px-6 py-2.5 rounded-xl font-bold text-sm bg-blue-600 hover:bg-blue-700 text-white shadow-md shadow-blue-600/20 transition-colors">Save Appointment</button>
            </div>
          </div>
        </div>
      )}
      ...
      {prepModal.isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white dark:bg-gray-800 w-full max-w-md rounded-3xl shadow-2xl overflow-hidden border border-cyan-100 dark:border-cyan-900/30 animate-in zoom-in-95 duration-200">
            <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20">
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2">
                  <Sparkles className="w-5 h-5 text-cyan-500" /> AI Prep Assistant
                </h3>
            ...
            <div className="p-6">
              <div className="bg-cyan-50 dark:bg-cyan-900/20 p-4 rounded-xl border border-cyan-100 dark:border-cyan-900/30 mb-5 flex gap-3">
                ...
                <p className="text-xs font-medium text-cyan-800 dark:text-cyan-300 leading-relaxed">
                  The AI will analyze your health profile and recent logs to draft relevant questions for your doctor, helping you make the most of your visit.
                </p>
              </div>
              
              <div>
                <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1.5">Specific symptoms or concerns? (Optional)</label>
                <textarea 
                  value={prepSymptoms} 
            ...
            <div className="px-6 py-4 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-100 dark:border-gray-700 flex justify-end gap-3">
              <button onClick={() => setPrepModal({ isOpen: false, aptId: null })} disabled={isPrepping} className="px-5 py-2.5 rounded-xl font-bold text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors disabled:opacity-50">Cancel</button>
      ...
      {viewPrepModal.isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white dark:bg-gray-800 w-full max-w-2xl max-h-[85vh] rounded-3xl shadow-2xl overflow-hidden border border-gray-100 dark:border-gray-700 flex flex-col animate-in zoom-in-95 duration-200">
            <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-800/50 shrink-0">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2">
                <Bot className="w-5 h-5 text-cyan-500" /> AI Prepared Notes
              </h3>
