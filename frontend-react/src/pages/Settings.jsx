...
const Settings = () => {
  ...
  return (
    <div className="flex-1 min-w-0 flex flex-col min-h-screen">
      ...
      <div className="p-8">
        {/* Header */}
        <div className="bg-white dark:bg-gray-800 rounded-[2.5rem] p-6 lg:p-8 shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
          <div className="flex items-center gap-5">
            ...
            <div>
              <h2 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight mb-1">Settings</h2>
          ...
          {/* Tabs */}
          <div className="flex p-1 bg-gray-100 dark:bg-gray-900/50 rounded-2xl border border-gray-200 dark:border-gray-700">
            <button 
